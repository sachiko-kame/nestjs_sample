...
db_check:
	...
	@echo '確認作業終了(◍•ᴗ•◍) ※この時点で『確認出来ませんでした。40/40 回目』の表示がある場合上手く言っていません。make db_check, make db_start 実行お願いします。'
...
db_start:
	...
	@echo 'DB構築終了(◍•ᴗ•◍) ※この時点で『上手くいきませんでした(最大40回繰り返します)。40/40 回目』の表示がある場合上手く言っていません。make db_start やり直しお願いします。'
